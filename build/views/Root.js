...
const Root = (0, mobx_react_lite_1.observer)(function Root() {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { id: "app-root", className: showContents ? "show-contents" : "", style: { display: 'flex', flexDirection: 'row' }, children: [isAuthenticated && ((0, jsx_runtime_1.jsxs)("div", { style: {
                    display: 'flex',
                    flexDirection: "row",
                    position: 'absolute',
                    top: 15,
                    ...
                    zIndex: 100,
                    gap: '10px'
                }, children: [(0, jsx_runtime_1.jsx)("button", { onClick: () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                            var _g;
                            yield ((_g = (0, pdos_1.default)().modules) === null || _g === void 0 ? void 0 : _g.auth.disconnectWalletUser());
                            location.reload();
                        }), children: "Disconnect" }), (0, jsx_runtime_1.jsx)("button", { onClick: () => setViewAccount(!viewAccount), children: viewAccount ? "View PDOS" : "View Account" })] })), (0, jsx_runtime_1.jsx)("img", { src: logo_png_1.default, width: 50, height: 50, style: { zIndex: 110, position: 'absolute', top: 15, left: 5 } }), (0, jsx_runtime_1.jsx)("img", { src: mountains_webp_1.default, width: 40, style: { zIndex: 100, height: '100vh', width: "60px", objectFit: 'cover' } }), (0, jsx_runtime_1.jsx)("div", { style: { position: 'relative', paddingLeft: '60px', height: "100vh", width: 'calc(100vw - 60px)' }, children: viewAccount ? ((0, jsx_runtime_1.jsx)(Account_1.default, {})) : ((0, jsx_runtime_1.jsxs)(core_1.SigmaContainer, { graph: graphology_1.DirectedGraph, settings: sigmaSettings, className: "react-sigma", children: [(0, jsx_runtime_1.jsx)(GraphEventsController_1.default, { setHoveredNode: setHoveredNode }), dataset && (0, jsx_runtime_1.jsx)(GraphDataController_1.default, { dataset: dataset, filters: filtersState }), dataReady && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "controls", children: [(0, jsx_runtime_1.jsx)("div", { className: "react-sigma-control ico", children: (0, jsx_runtime_1.jsx)("button", { type: "button", className: "show-contents", onClick: () => setShowContents(true), title: "Show caption and description", children: (0, jsx_runtime_1.jsx)(bi_1.BiBookContent, {}) }) }), (0, jsx_runtime_1.jsxs)(core_1.FullScreenControl, { className: "ico", children: [(0, jsx_runtime_1.jsx)(bs_1.BsArrowsFullscreen, {}), (0, jsx_runtime_1.jsx)(bs_1.BsFullscreenExit, {})] }), (0, jsx_runtime_1.jsxs)(core_1.ZoomControl, { className: "ico", children: [(0, jsx_runtime_1.jsx)(bs_1.BsZoomIn, {}), (0, jsx_runtime_1.jsx)(bs_1.BsZoomOut, {}), (0, jsx_runtime_1.jsx)(bi_1.BiRadioCircleMarked, {})] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "contents", children: [(0, jsx_runtime_1.jsx)("div", { className: "ico", children: (0, jsx_runtime_1.jsx)("button", { type: "button", className: "ico hide-contents", onClick: () => setShowContents(false), title: "Show caption and description", children: (0, jsx_runtime_1.jsx)(gr_1.GrClose, {}) }) }), (0, jsx_runtime_1.jsx)("div", { className: "panels", children: typeof hoveredNode == "object" && (0, jsx_runtime_1.jsx)(Panel_1.default, { initiallyDeployed: true, title: (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, {}), children: (0, jsx_runtime_1.jsx)("div", { style: { width: "450px", overflowX: 'scroll' }, children: hoveredNode && (0, jsx_runtime_1.jsx)(react_json_view_1.default, { src: hoveredNode }) }) }) })] })] }))] })) })] }));
});
